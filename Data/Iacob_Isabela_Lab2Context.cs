...
namespace Iacob_Isabela_Lab2.Data
{
    public class Iacob_Isabela_Lab2Context : DbContext
    {
        ...
        public DbSet<Iacob_Isabela_Lab2.Models.Publisher>? Publisher { get; set; }

        public DbSet<Iacob_Isabela_Lab2.Models.Category>? Category { get; set; }
        public DbSet<Iacob_Isabela_Lab2.Models.Author>? Author { get; set; }
    }
}
